...
def build_dataset(args):
	...
	if args.dataset == 'CK+':
		...
		main.log(args, str(time.clock() - start_time) + ' Images File Collected')
...
def build_structure(args, start_time, classes):
	for folder in [args.training_data, args.testing_data]:
		if not os.path.exists(folder):
			...
			for i in range(classes):
				os.makedirs(folder + '/frgb/' + str(i))
	main.log(args, str(time.clock() - start_time) + ' Folder Structure Built')
